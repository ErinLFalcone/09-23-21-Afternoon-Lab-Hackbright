...
for (const i in tradingCardData) {
  ReactDOM.render(
    (<TradingCard name={tradingCardData[i].name} skill={tradingCardData[i].skill} imgUrl={tradingCardData[i].imgUrl} />),
...
// ReactDOM.render(
//   <TradingCard name="Merge" skill="designated driver" imgUrl="/static/img/merge.png" />,
//   document.querySelector('#merge')
// );

// ReactDOM.render(
//   <TradingCard name="Recipe" skill="cuddling" imgUrl="/static/img/recipe.jpg" />,
